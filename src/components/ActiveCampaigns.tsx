        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-text mb-1 group-hover:text-white transition-colors duration-300">{activeCampaignLeads.length}</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-accent-red/10 rounded-2xl group-hover:bg-accent-red/20 transition-all duration-300 group-hover:scale-110">
                <CheckCircle className="h-6 w-6 text-accent-red group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-text mb-1">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-white/10">
                  {activeCampaignLeads.map((lead) => (
                    <tr 
                      key={lead.process_id} 
                      className="hover:bg-gradient-to-r hover:from-elevated hover:to-[#1a1a1a] transition-all duration-300 ease-out cursor-pointer group hover:shadow-lg hover:shadow-black/20"
                      onClick={() => handleRowClick(lead)}
                    >
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-accent-red rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <User className="h-4 w-4 text-white group-hover:drop-shadow-sm" />
                          </div>
                          <div>
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                          <Building className="h-4 w-4 text-muted group-hover:text-accent-red transition-colors duration-300" />
                          <div>
