        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-[#E11D48]/10 rounded-2xl group-hover:bg-[#E11D48]/20 transition-all duration-300 group-hover:scale-110">
                <MessageSquare className="h-6 w-6 text-[#E11D48] group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-white mb-1 group-hover:text-white transition-colors duration-300">{engagedLeads.length}</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-[#E11D48]/10 rounded-2xl group-hover:bg-[#E11D48]/20 transition-all duration-300 group-hover:scale-110">
                <AlertCircle className="h-6 w-6 text-[#E11D48] group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-white mb-1 group-hover:text-white transition-colors duration-300">{highPriorityLeads.length}</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-[#E11D48]/10 rounded-2xl group-hover:bg-[#E11D48]/20 transition-all duration-300 group-hover:scale-110">
                <CheckCircle2 className="h-6 w-6 text-[#E11D48] group-hover:drop-shadow-sm" />
              </div>
              <div>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-[#E11D48]/10 rounded-2xl group-hover:bg-[#E11D48]/20 transition-all duration-300 group-hover:scale-110">
                <TrendingUp className="h-6 w-6 text-[#E11D48] group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-white mb-1">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-[#2a2a2a]">
                    {engagedLeads.map((lead) => (
                      <tr key={lead.process_id} className="hover:bg-gradient-to-r hover:from-[#0B0B0F] hover:to-[#1a1a1a] transition-all duration-300 ease-out cursor-pointer group hover:shadow-lg hover:shadow-black/20">
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-medium text-white group-hover:text-white transition-colors duration-300">{lead.lead_name}</p>
                              {lead.booked_meeting && (
                        ...
                        <td className="p-4">
                          <p className="text-white font-medium group-hover:text-white transition-colors duration-300">{lead.lead_company_name || 'Unknown Company'}</p>
