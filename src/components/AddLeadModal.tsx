          ...
          {importMode === 'single' ? (
              ...
              <div className="bg-elevated rounded-2xl p-6 border border-white/5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      {...register('lead_name')}
                      className="futuristic-input w-full px-4 py-3 rounded-xl text-text placeholder-muted focus:outline-none"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-elevated rounded-2xl p-6 border border-white/5">
                ...
                <div className="border-2 border-dashed border-white/20 rounded-2xl p-8 text-center hover:border-accent-red/50 hover:bg-accent-red/5 transition-all duration-300 cursor-pointer group">
                  <input
                    type="file"
                    accept=".csv,.xlsx,.xls"
                  ...
                  >
                    <Upload className="h-8 w-8 text-muted group-hover:text-accent-red group-hover:scale-110 transition-all duration-300" />
