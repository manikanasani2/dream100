        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-accent-red/10 rounded-2xl group-hover:bg-accent-red/20 transition-all duration-300 group-hover:scale-110">
                <Calendar className="h-6 w-6 text-accent-red group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-text mb-1 group-hover:text-white transition-colors duration-300">{bookedMeetings.length}</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-accent-red/10 rounded-2xl group-hover:bg-accent-red/20 transition-all duration-300 group-hover:scale-110">
                <Target className="h-6 w-6 text-accent-red group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-text mb-1 group-hover:text-white transition-colors duration-300">{conversionRate.toFixed(1)}%</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-accent-red/10 rounded-2xl group-hover:bg-accent-red/20 transition-all duration-300 group-hover:scale-110">
                <DollarSign className="h-6 w-6 text-accent-red group-hover:drop-shadow-sm" />
              </div>
              <div>
                <p className="text-2xl font-bold text-text mb-1 group-hover:text-white transition-colors duration-300">${(bookedMeetings.length * 15000).toLocaleString()}</p>
          ...
          <div className="glass-card rounded-2xl p-6 group cursor-pointer">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-accent-red/10 rounded-2xl group-hover:bg-accent-red/20 transition-all duration-300 group-hover:scale-110">
                <Trophy className="h-6 w-6 text-accent-red group-hover:drop-shadow-sm" />
              </div>
              <div>
                    ...
                    <div key={industry} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-24 bg-white/10 rounded-full h-2">
                          <div 
                            className="bg-accent-red h-2 rounded-full transition-all duration-1000 progress-bar"
          ...
          <div className="bg-panels border border-white/10 rounded-2xl p-6">
            ...
            <div className="space-y-4">
              {bookedMeetings.slice(0, 5).map((lead) => (
                <div key={lead.process_id} className="flex items-center justify-between p-4 bg-elevated rounded-2xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all duration-300 ease-out cursor-pointer group hover:translate-x-1">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-[#10b981] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <User className="h-4 w-4 text-text group-hover:drop-shadow-sm" />
                    </div>
                    <div>
                      <p className="text-text font-medium group-hover:text-white transition-colors duration-300">{lead.lead_name}</p>
                      <p className="text-muted text-sm">{lead.lead_company_name}</p>
                    </div>
                  </div>
                  <CheckCircle2 className="h-5 w-5 text-[#10b981] group-hover:scale-110 transition-transform duration-300" />
                </div>
              ))}
            </div>
          </div>
                  ...
                  <tbody className="divide-y divide-white/10">
                    {bookedMeetings
                      ...
                      .map((lead) => {
                        ...
                        return (
                          <tr key={lead.process_id} className="hover:bg-gradient-to-r hover:from-elevated hover:to-[#1a1a1a] transition-all duration-300 ease-out cursor-pointer group hover:shadow-lg hover:shadow-black/20">
                            <td className="p-4">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-[#10b981] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                  <User className="h-4 w-4 text-text group-hover:drop-shadow-sm" />
                                ...
                                <div>
                                  <p className="font-medium text-text group-hover:text-white transition-colors duration-300">{lead.lead_name}</p>
                                  <div className="flex items-center gap-1 mt-1">
                                    <CheckCircle2 className="h-3 w-3 text-[#10b981] group-hover:scale-110 transition-transform duration-300" />
                            ...
                            <td className="p-4">
                              <p className="text-text font-medium group-hover:text-white transition-colors duration-300">{lead.lead_company_name || 'Unknown Company'}</p>
                            </td>
                            <td className="p-4">
